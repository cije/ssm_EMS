                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="changePageSize" onchange="changePageSize()">
                                <c:forEach begin="10" end="30" step="5" var="selectedSize">
                                    <c:choose>
                                        <c:when test="${pageInfo.pageSize==selectedSize}">
                                            <option selected>${selectedSize}</option>
                                        </c:when>
                                        <c:otherwise>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.prePage}&size=${pageInfo.pageSize}">上一页</a>
                            </li>
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.nextPage}&size=${pageInfo.pageSize}">下一页</a>
                            </li>
                            <li>
